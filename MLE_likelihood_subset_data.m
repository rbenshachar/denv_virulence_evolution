function RMS = MLE_likelihood_subset_data(v, parameters, indiv_PI, indiv_SI, vals)
...
x2 = cat(2, vals(1)*v(3), 5, 0, 5.9, parameters(13), v(2),0.2, 10^(-3),vals(2)*(vals(1)*v(3)),0.5, 0); %SI
